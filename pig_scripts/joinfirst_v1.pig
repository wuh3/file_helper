...
Flights1_Filtered = FILTER Flights1 BY Cancelled1 == 0.0 AND Diverted1 == 0.0;
Flights2_Filtered = FILTER Flights2 BY Cancelled2 == 0.0 AND Diverted2 == 0.0;

Flights1_Clean = FOREACH Flights1_Filtered GENERATE
    Year1,
    Month1,
    FlightDate1,
    Dest1 AS JoinAirport,
    ArrTime1,
    ArrDelayMinutes1;
